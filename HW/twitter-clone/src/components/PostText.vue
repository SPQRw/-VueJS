    ...
    <div class="card col-8 p-2 mb-4" v-for="post in posts" v-bind:key="post.id">
      ...
      <div class="row card-body">
        <button
          ...
          class="btn btn-primary mb-2 col-2 offset-10"
        >
          <i class="fas fa-comment-alt-plus"></i>
        </button>
        <button
          @click="post.likes++"
          class="btn btn-danger mb-2 col-2 offset-10"
        >
        ...
        <div class="row card-body" v-if="addCommentView">
          ...
          ></textarea>
          <button
            @click="sendComment(post, commentInput)"
            class="btn btn-primary self-align-right"
          >
            Отправить
          </button>
        </div>
